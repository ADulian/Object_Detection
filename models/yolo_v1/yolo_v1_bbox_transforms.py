""" Module that contains helpful functions specifically for transforming boundig boxes for YoloV1
"""
...
from custom_types.bbox import BBoxTransforms

class YoloV1BBoxTransforms(BBoxTransforms):
    """ Extends BBoxTransforms with transforms made specifically on bboxes w.r.t. YoloV1
    """
